(function (global, factory) {
    if (typeof define === "function" && define.amd) {
        define(['exports', './pallet', 'react', './config/mappings', './index.css'], factory);
    } else if (typeof exports !== "undefined") {
        factory(exports, require('./pallet'), require('react'), require('./config/mappings'), require('./index.css'));
    } else {
        var mod = {
            exports: {}
        };
        factory(mod.exports, global.pallet, global.react, global.mappings, global.index);
        global.index = mod.exports;
    }
})(this, function (exports, _pallet, _react, _mappings) {
    'use strict';
    ...
    var MaterialIcon = function (_React$Component) {
        ...
        _createClass(MaterialIcon, [{
            ...
            value: function render() {
                ...
                var styleOverride = { color: color ? color : '', fontSize: sizeMapped };
